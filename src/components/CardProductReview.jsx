        ...
        <div className="mt-16 ">
            ...
            <div className="w-full ml-16">
                ...
                <div className="flex gap-16 mt-10  border-y border-gray-300">
                    <a href="/">
                    <h1 className="text-xl font-semibold px-2 py-2 ml-10 hover:border-b-4 hover:border-yellow-300">
                        Detail
                    </h1>
                    </a>
                    <a href="/">
                    ...
                    <a href="/">
                    <h1 className="text-xl font-semibold px-2 py-2 ml-10 border-b-4 border-white hover:border-yellow-300 ">
                        Info Penting
                    </h1>
                    </a>
                </div>
                <div className=" mb-5 mt-5 text-sm">
                    ...
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Voluptas veritatis possimus, voluptatibus impedit at
                    consequatur incidunt minus consectetur, ab autem iure error
                    saepe natus soluta vero esse repellendus explicabo alias quis.
                    Vel natus eos doloribus aspernatur excepturi voluptatum, ipsum
                    neque sapiente asperiores praesentium dicta velit laboriosam
                    esse nisi sint ea id illum quod recusandae! Aliquid quod sed
                    excepturi ducimus adipisci. Est, deleniti totam aspernatur
                    suscipit mollitia placeat facere magni ullam. Quod similique
                    ut provident iusto necessitatibus veritatis nesciunt.
                    </p>
                </div>
                </div>
            </div>
