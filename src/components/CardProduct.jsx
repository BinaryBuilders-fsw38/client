  ...
  return (
    <>
      <div className="max-w-xs rounded overflow-hidden px-2 py-2 mb-4 mx-2">
        ...
        <div>
          <a href="#" className="MuiTypography-root" id="plugin-productTitle-typography">
            Bodypack Credo Pouch - Cream
          </a>
          <div className="mt-7">
            <p className="MuiTypography-root jss935 jss943 jss949 jss954 jss929 jss945 jss1267 price_text MuiTypography-caption MuiTypography-alignLeft">
              IDR <b> 349,000.00 </b>
            </p>
          </div>
        </div>
