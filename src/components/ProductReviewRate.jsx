    ...
    return (
        ...
        <div className="flex items-center mb-4">
            ...
            <span className="text-gray-600">{`${rating.toFixed(1)} (${totalReviews} reviews)`}</span>
        </div>
        <div className="mb-4">
            <div className="flex items-center">
            <span className="w-16 font-bold mr-2 flex gap-2 align-baseline"><FaStar className='text-yellow-400 pt-1'/> 5</span>
            ...
            <div className="flex items-center">
            <span className="w-16 font-bold mr-2 flex gap-2"><FaStar className='text-yellow-400 pt-1'/> 4</span>
            <div className="relative w-full bg-gray-200 rounded-full">
                <div
                className="bg-green-500 h-2 rounded-full"
            ...
            <div className="flex items-center">
            <span className="w-16 font-bold mr-2 flex gap-2"><FaStar className='text-yellow-400 pt-1'/> 3</span>
            <div className="relative w-full bg-gray-200 rounded-full">
                <div
                className="bg-green-500 h-2 rounded-full"
            ...
            <div className="flex items-center">
            <span className="w-16 font-bold mr-2 flex gap-2"><FaStar className='text-yellow-400 pt-1'/> 2</span>
            <div className="relative w-full bg-gray-200 rounded-full">
                <div
                className="bg-green-500 h-2 rounded-full"
            ...
            <div className="flex items-center">
            <span className="w-16 font-bold mr-2 flex gap-2"><FaStar className='text-yellow-400 pt-1'/> 1</span>
            <div className="relative w-full bg-gray-200 rounded-full">
                <div
                className="bg-green-500 h-2 rounded-full"
