        ...
        <div className="flex flex-wrap -mx-2">
          ...
          <div className="login w-full md:w-1/2 px-2 text-left">
            ...
            <div className="keterangan mt-10">
              ...
              <div className="input border-t-2 border-gray-200 mb-4">
              </div>
              <p className="mb-2">Jika kamu sudah mempunyai akun, silahkan masuk dengan email.</p>
            </div>
            ...
            <div className="lupaPass">
              <a href="#" className="text-sm text-black">Lupa Password</a>
            </div>
          ...
          <div className="w-full md:w-1/2 px-2 text-left">
            ...
            <div className="keterangan"style={{ marginTop: '76px' }}>
              ...
              <p className="mb-2">Membuat akun akan mendapatkan benefit : checkout dengan cepat, simpan lebih dari satu alamat pengiriman, lacak pembelian and masih banyak lagi.</p>
            </div>
